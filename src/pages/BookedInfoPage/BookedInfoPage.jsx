          ...
          {bookings.map((booking, index) => (
            <li key={index}>
              <div className="booking-details">
                <strong>User:</strong> {booking.userId ? booking.userId.name : "N/A"}
              </div>
              <div className="booking-details">
                <strong>Email:</strong> {booking.userId ? booking.userId.email : "N/A"}
              </div>
              <div className="booking-details">
                <strong>Event:</strong> {booking.eventId ? booking.eventId.title : "Event Not Found"}
              </div>
              <div className="booking-details">
                <strong>Location:</strong> {booking.eventId ? booking.eventId.location : "N/A"}
              </div>
              <div className="booking-details">
